...
\chapter{Introductuin to Cluster Analysis}
...
\begin{itemize}
	...
	\item \textbf{Important:} cluster analysis simply discovers structures in data without explaining why they exist. Like factor 
	analysis, it examines the full complement
...
\begin{itemize}
	...
	\item For nearly all of this module example,the data were on an interval scale, and the squared euclidean measure will suffice.
\end{itemize} 
