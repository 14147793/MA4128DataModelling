...
\section{Cook's 1986 paper on Local Influence}%1.7.1
...
%-------------------------------------------------------------------------------------------------------------------------------------%
%-------------------------------------------------------------------------------------------------Chapter 2	------------------------%
	\section{Iterative and non-iterative influence analysis for LMEs} %1.13
...
\section{Summary of Influence Statistics}
\begin{itemize}
...
%---------------------------------------------------------------------------%
\newpage
\chapter{CPJ and Case Deletion Diagnostic}
...
\newpage
	...
	\section{Variance Ratio} %2.4.2
	\begin{itemize}
		\item For fixed effect parameters $\beta$.
	\end{itemize}
	
	\section{Cook-Weisberg statistic} %2.4.3
	\begin{itemize}
		\item For fixed effect parameters $\beta$.
	\end{itemize}
	
	\section{Andrews-Pregibon statistic} %2.4.4
	\begin{itemize}
		\item For fixed effect parameters $\beta$.
	\end{itemize}
...
In classical linear regression, a commonly used meausre of influence is Cook's distance. It is used as a measure of influence on the regression coefficients. \index{Cook's distance}Cook's Distance is a well known diagnostic technique used in classical linear models, extended to LME models.  
\subsection{Cooks's Distance Background}%1.9.2
...
\subsection{Cooks's Distance in OLS Models}%1.9.2
...
\subsection{Extending Cook's Distance to LME Models}%1.9.3
